...
<link rel="stylesheet" href="<%=request.getContextPath()%>/plugins/wizard/wizard.css"/>
<!-- Font Awesome -->
...
<link type="text/css" href="<%=request.getContextPath()%>/util/bootstrap-fileinput/css/fileinput.min.css" rel="stylesheet"/>
<link type="text/css" href="<%=request.getContextPath()%>/plugins/daterangepicker/daterangepicker.css" rel="stylesheet"/>
<link type="text/css" href="<%=request.getContextPath()%>/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet"/>
