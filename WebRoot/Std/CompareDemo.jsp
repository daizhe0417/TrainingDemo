...
<div class="box">
    ...
    <div class="box-body">
        ...
        <div id="dzGridContainer" class="dataTables_wrapper form-inline dt-bootstrap">
            <%--<div class="row">--%>
            <%--<div class="col-sm-12">--%>
            <%--<table id="example1" class="table table-bordered table-striped dataTable" style="table-layout: fixed;">--%>
            <%--<thead>--%>
            <%--<tr role="row">--%>
            <%--<th class="sorting_asc" style="width: 1993px;">Rendering engine--%>
            <%--</th>--%>
            <%--<th class="sorting" style="width: 1246px;">Browser--%>
            <%--</th>--%>
            <%--<th class="sorting" style="width: 1229px;">--%>
            <%--Platform(s)--%>
            <%--</th>--%>
            <%--<th class="sorting" tabindex="0"style="width: 1229px;" aria-controls="example1" rowspan="1" colspan="1"--%>
            ...
            <%--<label style="margin-top: 3px;">显示 1-10 共34条</label>--%>
            <%--</div>--%>
            <%--</div>--%>
            <%--<div class="col-sm-2">--%>
            <%--<div class="dataTables_length">--%>
            <%--<label>每页--%>
            <%--<select id="example1_rowsPerPage" name="example1_length" class="form-control input-sm">--%>
    ...
    <%--<div class="modal-dialog">--%>
        <%--<div class="modal-content">--%>
            <%--<div class="modal-header">--%>
                <%--<button type="button" class="close" data-dismiss="modal" aria-label="Close">--%>
                    <%--<span aria-hidden="true">×</span></button>--%>
                <%--<h4 id="compareTitle" class="modal-title">产品对比</h4>--%>
            <%--</div>--%>
            <%--<div class="modal-body">--%>
                <%--<table id="example1" class="table table-bordered table-striped dataTable" style="table-layout: fixed;">--%>
                    <%--<tbody>--%>
                    <%--<tr class="row">--%>
                        <%--<td class="col-md-10 text-center">是大法师打发士大夫撒旦法</td>--%>
                        <%--<td class="col-md-2 text-center">--%>
                            <%--<div id="removeCompareItem_1"><i class="fa fa-fw fa-close"></i></div>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <%--<tr class="row">--%>
                        <%--<td class="col-md-10 text-center">是大法师打发士大夫撒旦法</td>--%>
                        <%--<td class="col-md-2 text-center">--%>
                            <%--<div id="removeCompareItem_2"><i class="fa fa-fw fa-close"></i></div>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <%--<tr class="row">--%>
                        <%--<td class="col-md-10 text-center">是大法师打发士大夫撒旦法</td>--%>
                        <%--<td class="col-md-2 text-center">--%>
                            <%--<div id="removeCompareItem_3"><i class="fa fa-fw fa-close"></i></div>--%>
                        <%--</td>--%>
                    <%--</tr>--%>
                    <%--</tbody>--%>
                <%--</table>--%>
            <%--</div>--%>
            <%--<div class="modal-footer">--%>
                <%--<button type="button" id="toCompareBtn" class="btn btn-primary pull-left"--%>
                        <%--data-dismiss="modal">开始对比--%>
                <%--</button>--%>
                <%--<button type="button" id="clearCompareBtn" class="btn btn-success ">清空</button>--%>
            <%--</div>--%>
        <%--</div>--%>
    <%--</div>--%>
</div>
<%@include file="../commonjs.jsp" %>
<script src="<%=request.getContextPath()%>/plugins/dzCompare/dzCompare.js?random=<%=Math.random()%>"></script>
<script src="<%=request.getContextPath()%>/Std/js/compareDemo.js?random=<%=Math.random()%>"></script>
</body>
</html>
