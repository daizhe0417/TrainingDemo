                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="form-group col-xs-4">
                            ...
                            <select class="form-control input-sm select2 select2-hidden-accessible"
                                    ...
                                    style="width: 100%;" tabindex="-1" aria-hidden="true"
                                    id="managementId" name="managementId" required>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <%--<div class="row">--%>
                        <%--<div class="form-group col-xs-6">--%>
                            ...
                            <%--<input class="form-control" id="foundDate" name="foundDate" required>--%>
                        <%--</div>--%>
                        <%--&lt;%&ndash;<div class="form-group col-xs-4">&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<label for="scale">规模</label>&ndash;%&gt;--%>
                            <%--&lt;%&ndash;<input class="form-control" id="scale" name="scale" required>&ndash;%&gt;--%>
                        <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
                        <%--<div class="form-group col-xs-6">--%>
...
<script src="<%=request.getContextPath()%>/Std/js/product.js?random=<%=Math.random()%>"></script>
</body>
</html>
